...
import { ScanLine, LogIn, MapPin, AlertCircle, CheckCircle, Loader, Keyboard } from 'lucide-react';
...
const EntryScanner: React.FC = () => {
  ...
  const handleScan = async (qrData: string) => {
    ...
    try {
      ...
      // Process entry
      const response = await journeyService.entry({
        mediaType,
        mediaId,
      ...
      setError(err.response?.data?.message || err.message || 'Failed to process entry');
    } finally {
      setProcessing(false);
    }
  };
          ...
          <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-6 text-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-green-100 text-sm">Scan QR code for journey entry</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
            ...
            {!result && (
              <div className="mb-6">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none text-lg"
                >
            ...
            {!result && selectedStation > 0 && !scanning && (
              <div className="flex gap-3 mb-6">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 bg-green-600 text-white py-4 rounded-lg font-semibold hover:bg-green-700 transition"
                >
            ...
            {processing && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 font-medium">Processing entry...</p>
              </div>
            )}
            ...
            {manualMode && !processing && !result && (
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none text-lg font-mono"
                />
            ...
            {result && result.success && (
              <div className="text-center py-8">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Entry Permitted!</h2>
                ...
                <div className="bg-green-50 border-2 border-green-200 rounded-lg p-6 mb-6">
                  <div className="grid grid-cols-2 gap-4 text-left">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">{result.data.station.name}</p>
                    </div>
                    {result.data.currentBalance !== undefined && (
                      <div>
                        <p className="text-sm text-gray-600">Card Balance</p>
                        <p className="font-semibold text-gray-900">₹{result.data.currentBalance.toFixed(2)}</p>
                      </div>
                    )}
                  </div>
                </div>
